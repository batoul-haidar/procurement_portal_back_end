...
public class ListProductsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String productTypeIdParam = request.getParameter("product_type_id");
        PrintWriter out = response.getWriter();
        
        try {
            int productTypeId = Integer.parseInt(productTypeIdParam);
            PurchaserReqDAO reqDao = new PurchaserReqDAOImp();
            List<Product> products = reqDao.getProductsByType(productTypeId);
            
            Gson gson = new Gson();
            String jsonWrite = gson.toJson(products);
