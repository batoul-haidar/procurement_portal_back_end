 ...
 ** @author BATOUL
 */
public class ListProductTypesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ProductType> productTypes = reqDao.getProductTypesByCategory(categoryId);
            
            Gson gson = new Gson();
            String jsonWrite = gson.toJson(productTypes);
        ...
        JsonObject jsonRead = gsonRead.fromJson(reader, JsonObject.class);
        
        int categoryId = jsonRead.get("category_id").getAsInt();
        ...
        try {               
              ...
              //  addUser.setUser(user_type, user_full_name, user_name, password, user_departement, other_departement);
                    ...
                    response.setStatus(HttpServletResponse.SC_OK);
                    List<ProductType> productTpes = reqDao.getProductTypesByCategory(categoryId);
                    Gson gsonWrite = new Gson();
                    String jsonWrite = gsonWrite.toJson(productTpes);
                    out.print(jsonWrite);
                    out.flush();
