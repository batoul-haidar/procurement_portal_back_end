...
public class CloseRequestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       //     int requestId = Integer.parseInt(requestIdParam);
            PurchaserReqDAO purchaseDao = new PurchaserReqDAOImp();
            purchaseDao.closeRequest(requestId);
            ...
            int technicianId = purchaseDao.getTechnicianByRequestID(requestId);
            notificationService.addNotification("Request Closed", "history.html", technicianId, null);
