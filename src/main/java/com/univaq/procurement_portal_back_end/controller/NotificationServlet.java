...
public class NotificationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<Notification> notifications = notificationService.getNotificationsForUser(userId, userType);

            Gson gson = new Gson();
            String jsonNotifications = gson.toJson(notifications);
            out.print(jsonNotifications);
            out.flush();

            // Mark notifications as read
            notificationService.markNotificationsAsRead(userId, userType);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
